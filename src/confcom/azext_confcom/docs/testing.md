...
test_remote_fragment_references | mcr.microsoft.com/acc/samples/aci/helloworld:2.9 & mcr.microsoft.com/cbl-mariner/busybox:1.35 | Test standard standalone fragment usage
