...
- **Description**: Defines reusable policy fragments that can be referenced and imported into container policies.
...
| `capabilities`    | object  | No       | Linux capabilities to add or drop (e.g., `add`, `drop` arrays).                             |
