...
ACI_FIELD_TEMPLATE_ALLOW_PRIVILEGE_ESCALATION = "allowPrivilegeEscalation"
...
SVN_FRAMEWORK_VERSION = "1.0.0" #os_util.load_str_from_file(SVN_FRAMEWORK_PATH)
# api svn file
SVN_API_FILE = "./data/svn_api"
SVN_API_PATH = f"{script_directory}/{SVN_API_FILE}"
SVN_API_VERSION = "0.10.0" #os_util.load_str_from_file(SVN_API_PATH)
